 ...
 * A directional light source has a specific direction and its intensity does not
...
public class DirectionalLight extends Light implements LightSource {
    ...
    /**
     * Returns the intensity (color) of the light at the specified point.
     * For a directional light, the intensity is the same everywhere.
     *
    ...
    /**
     * Returns the direction of the light from the light source to the specified point.
     * For a directional light, the direction is the same everywhere.
     *
