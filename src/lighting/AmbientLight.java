 ...
 * Ambient light is a global light source that illuminates all objects equally,
 * providing a base level of light without direction.
 */
public class AmbientLight {
     ...
     * @param ka the intensity coefficient of the ambient light (as a Double3 object).
     */
