...
/**
 * Class representing a scene in a 3D graphics application.
 * A scene consists of a name, background color, ambient light, and geometries.
 */
public class Scene {
     ...
     * @return the current Scene object (for method chaining).
     */
    public Scene setmAbientLight(AmbientLight ambientLight) {
