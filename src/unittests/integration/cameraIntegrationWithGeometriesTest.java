...
/**
 * Integration tests for Camera ray construction and intersection with geometries.
 * @author Yoni and adiel
 */
public class cameraIntegrationWithGeometriesTest {

    /**
     * Helper method to generate rays through all pixels of a view plane and count intersections with a given geometry.
     * 
    ...
    /**
     * Test for intersection of rays with a sphere.
     * This test checks various scenarios where rays from the camera intersect with a sphere.
     * It verifies the number of intersection points for each scenario.
     */
    @Test
    void testSphereIntersection() {
        ...
        assertEquals(2, countIntersections(camera, new Sphere(new Point(0, 0, -3), 1), 3, 3),
                "Unexpected number of intersections with sphere");
        ...
        assertEquals(18, countIntersections(camera, new Sphere(new Point(0, 0, -2.5), 2.5), 3, 3),//
                "Unexpected number of intersections with sphere");

        // TC03: 10 intersection points
        assertEquals(10, countIntersections(camera, new Sphere(new Point(0, 0, -2), 2), 3, 3),//
                "Unexpected number of intersections with sphere");

        // TC04: 9 intersection points
        assertEquals(9, countIntersections(camera, new Sphere(new Point(0, 0, 0), 4), 3, 3),//
                "Unexpected number of intersections with sphere");

        // TC05:  0 intersection points
        assertEquals(0, countIntersections(camera, new Sphere(new Point(0, 0, 1), 0.5), 3, 3),//
                "Unexpected number of intersections with sphere");
    }

    /**
     * Test for intersection of rays with a plane.
     * This test checks various scenarios where rays from the camera intersect with a plane.
     * It verifies the number of intersection points for each scenario.
     */
    @Test
    void testPlaneIntersection() {
        ...
        assertEquals(9, countIntersections(camera, new Plane(new Point(0, 0, -3), new Vector(0, 0, 1)), 3, 3),//
                "Unexpected number of intersections with plane");
    ...
    /**
     * Test for intersection of rays with a triangle.
     * This test checks various scenarios where rays from the camera intersect with a triangle.
     * It verifies the number of intersection points for each scenario.
     */
    @Test
    void testTriangleIntersection() {
        ...
        assertEquals(1, countIntersections(camera, new Triangle(new Point(0, 1, -2), //
                ...
                "Unexpected number of intersections with triangle");
