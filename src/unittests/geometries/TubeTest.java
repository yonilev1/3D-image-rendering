...
class TubeTest {
	...
	void testGetNormal() {
		...
		//if the vector from the surface point to head point is orthogonal to the direction point
		Vector v2 =t.getNormal(new Point (4,1,0));

		assertEquals(new Vector (0,1,0), v2 ,"getNormal() wrong when point on surface is peralle to head point result");
	}
