...
public class PlaneTest {
	...
	void testFindIntersections() {
		// ???? Plane plane = new Plane(new Point(1, 0, 0), new Point(0, 1, 0), new
		// Point(0, 0, 1)); the normal is (1,1,1) switch point a and c ?????
		Plane plane = new Plane(new Point(0, 0, 1), new Point(0, 1, 0), new Point(1, 0, 0)); // the normal is upside
																								// (-1,-1,-1)
		...
		assertEquals(List.of(new Point(-2.666666666666667, -1.666666666666667, 5.333333333333333)), result5,
		...
		// TC16: Ray is neither orthogonal nor parallel to and begins at the point
		// reference the plane
		...
		// TC17:Ray is neither orthogonal nor parallel to and begins at any point in the
		// plane
