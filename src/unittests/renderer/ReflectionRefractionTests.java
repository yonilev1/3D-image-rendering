...
public class ReflectionRefractionTests {
	...
	public void geometryCombinationTest() {
		...
		scene.geometries.add( //
				new Sphere(new Point(-20,-20, -50), 20d).setEmission(new Color(255,190,0))
				.setMaterial(new Material().setKD(0.001).setKS(0.05).setShininess(10).setKT(0.3)),
		        ...
		        new Sphere(new Point(-35, 20, 0),50d).setEmission(new Color(RED)) //
		          .setMaterial(new Material().setKD(0.2).setKS(0.2).setShininess(30).setKT(0.7)));

		scene.lights.add(new SpotLight(new Color(400, 700, 400), new Vector(0,0,-1), new Point(0, 0, 50)) //
